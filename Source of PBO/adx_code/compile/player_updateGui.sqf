...
switch true do
{
    ...
    {
        _typeHumanity = "\z\addons\adx_code\gui\status_humanity_inside_hero_3.paa";
    };
    case ((_humanity >= 4000) and (_humanity < 8000))://hero 2
    {
        _typeHumanity = "\z\addons\adx_code\gui\status_humanity_inside_hero_2.paa";
    };
    case ((_humanity >= 1000) and (_humanity < 4000))://hero 1
    {
        _typeHumanity = "\z\addons\adx_code\gui\status_humanity_inside_hero_1.paa";
    };
    case (_humanity <= -8000)://bandit 3
    {
        _typeHumanity = "\z\addons\adx_code\gui\status_humanity_inside_bandit_3.paa";
    };
    case ((_humanity <= -4000) and (_humanity > -8000))://bandit 2
    {
        _typeHumanity = "\z\addons\adx_code\gui\status_humanity_inside_bandit_2.paa";
    };
    case ((_humanity <= -1000) and (_humanity > -4000))://bandit 1
    {
        _typeHumanity = "\z\addons\adx_code\gui\status_humanity_inside_bandit_1.paa";
    };
    default
    {
        _typeHumanity = "\z\addons\adx_code\gui\st_humanity_survivor.paa";
    };
};
