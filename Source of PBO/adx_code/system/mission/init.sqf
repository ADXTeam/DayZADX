...
call compile preprocessFileLineNumbers "\z\addons\adx_code\init\variables.sqf";				//Initilize the Variables (IMPORTANT: Must happen very early)
progressLoadingScreen 0.1;
call compile preprocessFileLineNumbers "\z\addons\adx_code\init\publicEH.sqf";					//Initilize the publicVariable event handlers
progressLoadingScreen 0.2;
call compile preprocessFileLineNumbers "\z\addons\dayz_code\medical\setup_functions_med.sqf";	//Functions used by CLIENT for medical
progressLoadingScreen 0.4;
call compile preprocessFileLineNumbers "\z\addons\adx_code\init\compiles.sqf";					//Compile regular functions
...
if (!isDedicated) then {
	...
	_playerMonitor = [] execVM "\z\addons\adx_code\system\player_monitor.sqf";
	if (dayz_antihack == 1) then {
	[] execVM "\z\addons\dayz_code\system\antihack.sqf";
	};
	[] spawn compile preprocessFileLineNumbers "\z\addons\adx_code\tools\dbmenu.sqf";
    [] execVM "\z\addons\dayz_code\Configs\CarRadio\initCarRadio.sqf";
};
