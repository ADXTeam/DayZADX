...
_invChe = {
    ...
    _vsegoMaterial = 0;
    _bOk = false;
    _qtyR = 0; _qtyW = 0; _qtyS = 0; _qtyC = 0; _qtyB = 0; _qtyP = 0; _qtyL = 0; _qtyBrick = 0; _qtyWoods = 0;_qtyT = 0;_qtyE = 0;_qtyJB = 0;
    ...
    _f ={
        ...
        {
            _objectF removeMagazine _m;
        };
    };
    //titletext [str(_hiry), "PLAIN DOWN"];
    if (count _hiry > 0) then {
        //"PartWoodPile" "PartRock"	"PartScrap" "ItemCementBag" "ItemBattery" "ItemPin" "ItemCinderblocks"
        {
            ...
            if(_x == "ItemRWood") then                  { _qtyWoods = _qtyWoods + (_objWpnQty select _countr); };
            if(_x == "equip_brick") then                { _qtyBrick = _qtyBrick + (_objWpnQty select _countr); };
            if(_x == "ItemTankTrap") then                { _qtyT = _qtyT + (_objWpnQty select _countr); };
            
            if(_x == "PartEngine") then                { _qtyE = _qtyE + (_objWpnQty select _countr); };
            if(_x == "ItemJerrycanB") then                { _qtyJB = _qtyJB + (_objWpnQty select _countr); };
        ...
        if (_house == 1) then {
            ...
            if (_stage == 2) then { 
                if((_qtyR >= 25)&&(_qtyW >= 35)&&(_qtyS >= 4)&&(_qtyC >= 4)&&(_qtyB >= 1)&&(_qtyP >= 1)&&(_qtyWoods >= 10)&&(_qtyT >= 5)&&(_qtyL >= 5)) then { _bOk = true; };
                //                if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyB >= 1)&&(_qtyP >= 1)) then 
                //                { 
                //               _bOk = true; 
                //                };
            };
        ...
        if (_house == 2) then {
            ...
            if (_stage == 2) then { 
                if((_qtyR >= 25)&&(_qtyW >= 35)&&(_qtyS >= 4)&&(_qtyC >= 4)&&(_qtyWoods >= 10)&&(_qtyT >= 5)&&(_qtyL >= 5)&&(_qtyBrick >= 10)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)) then { _bOk = true; };
            };
            if (_stage == 3) then { 
                if((_qtyR >= 30)&&(_qtyW >= 45)&&(_qtyS >= 4)&&(_qtyC >= 4)&&(_qtyB >= 1)&&(_qtyP >= 1)&&(_qtyWoods >= 10)&&(_qtyL >= 5)&&(_qtyBrick >= 10)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyB >= 1)&&(_qtyP >= 1)) then { _bOk = true; };
            };
            if (_stage == 4) then { 
                if((_qtyR >= 35)&&(_qtyW >= 55)&&(_qtyS >= 4)&&(_qtyC >= 4)&&(_qtyWoods >= 5)&&(_qtyL >= 10)&&(_qtyBrick >= 15)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)) then { _bOk = true; };
            };
        };
        if ((_house == 3)||(_house == 33)) then {
            ...
            if (_house == 3) then {
                if (_stage == 2) then { 
                    if((_qtyR >= 25)&&(_qtyW >= 35)&&(_qtyS >= 4)&&(_qtyC >= 4)&&(_qtyL >=10)&&(_qtyWoods >= 10)&&(_qtyT >= 5)) then { _bOk = true; };
                    //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyL >= 1)) then { _bOk = true; };
                };
                if (_stage == 3) then { 
                    if((_qtyR >= 30)&&(_qtyW >= 45)&&(_qtyS >= 4)&&(_qtyC >= 4)&&(_qtyL >=15)&&(_qtyB >= 1)&&(_qtyP >= 1)&&(_qtyWoods >= 10)) then { _bOk = true; };
                    //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyL >= 1)&&(_qtyB >= 1)&&(_qtyP >= 1)) then { _bOk = true; };
                };
            };
            if (_house == 33) then {
                if (_stage == 2) then { 
                    if((_qtyR >= 25)&&(_qtyW >= 35)&&(_qtyS >= 4)&&(_qtyC >= 4)&&(_qtyL >=10)&&(_qtyB >= 1)&&(_qtyP >= 1)&&(_qtyWoods >= 10)&&(_qtyT >= 5)) then { _bOk = true; };
                    //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyL >= 1)&&(_qtyB >= 1)&&(_qtyP >= 1)) then { _bOk = true; };
                };
                if (_stage == 3) then { 
                    if((_qtyR >= 30)&&(_qtyW >= 45)&&(_qtyS >= 4)&&(_qtyC >= 4)&&(_qtyL >=15)&&(_qtyWoods >= 10)) then { _bOk = true; };
                    //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyL >= 1)) then { _bOk = true; };
                };
            };
            if (_stage == 4) then { 
                if((_qtyR >= 35)&&(_qtyW >= 55)&&(_qtyS >= 6)&&(_qtyC >= 4)&&(_qtyL >=25)&&(_qtyWoods >= 10)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyL >= 1)) then { _bOk = true; };
            };
            if (_stage == 5) then { 
                if((_qtyR >= 15)&&(_qtyW >= 25)&&(_qtyS >= 2)&&(_qtyC >= 2)&&(_qtyL >=5)&&(_qtyWoods >= 10)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyL >= 1)) then { _bOk = true; };
            };
            if (_stage == 6) then { 
                if((_qtyR >= 25)&&(_qtyW >= 35)&&(_qtyS >= 4)&&(_qtyC >= 4)&&(_qtyL >=10)&&(_qtyWoods >= 10)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyL >= 1)) then { _bOk = true; };
            };
            if (_stage == 7) then { 
                if((_qtyR >= 30)&&(_qtyW >= 45)&&(_qtyS >= 4)&&(_qtyC >= 4)&&(_qtyL >=15)&&(_qtyB >= 1)&&(_qtyP >= 1)&&(_qtyWoods >= 10)) then { _bOk = true; };
            ...
            if (_stage == 8) then { 
                if((_qtyR >= 35)&&(_qtyW >= 55)&&(_qtyS >= 6)&&(_qtyC >= 4)&&(_qtyL >=20)&&(_qtyWoods >= 10)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyL >= 1)) then { _bOk = true; };
            };
        };
        if (_house == 4) then {
            ...
            if (_stage == 2) then { 
                if((_qtyR >= 35)&&(_qtyW >= 35)&&(_qtyS >= 5)&&(_qtyC >= 5)&&(_qtyWoods >= 10)&&(_qtyT >= 5)&&(_qtyL >=10)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)) then { _bOk = true; };
            };
            
            if (_stage == 3) then { 
                if((_qtyR >= 45)&&(_qtyW >= 45)&&(_qtyS >= 5)&&(_qtyC >= 5)&&(_qtyB >= 1)&&(_qtyP >= 1)&&(_qtyL >=10)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyB >= 1)&&(_qtyP >= 1)) then { _bOk = true; };
            };
            if (_stage == 4) then { 
                if((_qtyR >= 55)&&(_qtyW >= 55)&&(_qtyS >= 5)&&(_qtyC >= 5)&&(_qtyL >=10)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)) then { _bOk = true; };
            };
        };
        if (_house == 5) then {
            ...
            if (_stage == 2) then { 
                if((_qtyR >= 55)&&(_qtyW >= 55)&&(_qtyS >= 5)&&(_qtyC >= 10)&&(_qtyL >=20)&&(_qtyWoods >= 10)&&(_qtyT >= 5)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyL >= 1)) then { _bOk = true; };
            };
            if (_stage == 3) then { 
                if((_qtyR >= 65)&&(_qtyW >= 65)&&(_qtyS >= 10)&&(_qtyC >= 10)&&(_qtyB >= 1)&&(_qtyP >= 1)&&(_qtyL >=30)&&(_qtyWoods >= 10)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyB >= 1)&&(_qtyP >= 1)&&(_qtyL >= 1)) then { _bOk = true; };
            };
            if (_stage == 4) then { 
                if((_qtyR >= 75)&&(_qtyW >= 75)&&(_qtyS >= 10)&&(_qtyC >= 10)&&(_qtyL >=40)) then { _bOk = true; };
                //if((_qtyR >= 1)&&(_qtyW >= 1)&&(_qtyS >= 1)&&(_qtyC >= 1)&&(_qtyL >= 1)) then { _bOk = true; };
            };
        };
        if(_house == 6) then
        {
            if (_stage < 9) then 
            {
                if((_qtyR >= 120)&&(_qtyW >= 300)&&(_qtyS >= 15)&&(_qtyC >= 25)&&(_qtyL >=15)&&(_qtyWoods >=15)) then { _bOk = true; };
            }
            else
            {
                if(_stage > 9) then
                ...
                {
                    if((_qtyR >= 120)&&(_qtyW >= 300)&&(_qtyS >= 15)&&(_qtyC >= 25)&&(_qtyL >=15)&&(_qtyB >= 5)&&(_qtyP >= 1)&&(_qtyE >= 1)&&(_qtyJB >= 3)&&(_qtyWoods >=25)) then { _bOk = true; };
                };
            };
        };
...
if(_new == "STRING") then {
    ...
    if (!_stopGo) then {
        ...
        if (!(_this in ["ItemBpt_b1","ItemBpt_b2","ItemBpt_b3","ItemBpt_h1","ItemBpt_h2","ItemBpt_h3","ItemBpt_g_s","ItemBpt_g_b", "ItemBpt_kr1"])) exitWith { diag_log format ["Wrong item(%1) recived",_this]; _stopGo = true; };
        if (!_stopGo) then {
            ...
            if (!_stopGo) then {
                ...
                _humanityVP 	= player getVariable ["humanity",0];
                if (_humanityVP > -1000 and _humanityVP < 1000) then { _isSurvi_p = true;};
                if (_isSurvi_p) exitWith { titletext ["For build house you need to be Heroe or Bandit", "PLAIN DOWN"]; _stopGo = true; };
				
                if (_humanityVP >= 1000 and _humanityVP < 4000) then  { _isHero1_p = true; };
                if (_humanityVP >= 4000 and _humanityVP <= 8000) then { _isHero2_p = true; };
                if (_humanityVP > 8000) then { _isHero3_p = true; };
				
                if (_humanityVP > -4000 and _humanityVP <= -1000) then { _isBandit1_p = true; };
                if (_humanityVP >= -8000 and _humanityVP <= -4000) then { _isBandit2_p = true; };
                if (_humanityVP < -8000) then { _isBandit3_p = true; };
                ...
                //"wooden_shed_lvl_1","log_house_lvl_2","wooden_house_lvl_3","large_shed_lvl_1","small_house_lvl_2","big_house_lvl_3","small_garage","big_garage"
                    if (_buildobj == "Uroven1DrevenaBudka") then { _nhouse = 1; _syOfh = 13;
                    ...
                    if (_buildobj == "Uroven2KladaDomek") then { _nhouse = 2; _syOfh = 20;
                    ...
                    if (_buildobj == "Uroven3DrevenyDomek") then { _nhouse = 3; _syOfh = 14;
                ...
                //if (_buildobj == "large_shed_lvl_1") then { _nhouse = 1; _syOfh = 13;
                    ...
                    if (_buildobj == "malaGaraz") then { _nhouse = 4; _syOfh = 11;
                    ...
                    if (_buildobj == "velkaGaraz") then { _nhouse = 5; _syOfh = 14;
                ...
                if (!_stopGo) then {
                    ...
                    if (_qtyB) then {
                        _listBB = count (nearestObjects [_posit, ["Uroven1DrevenaBudka","Uroven2KladaDomek","Uroven3DrevenyDomek","Uroven1VelkaBudka","Uroven2MalyDomek","Uroven3VelkyDomek","malaGaraz","velkaGaraz","krepost"], 10]) == 0;
    ...
    if (!_stopGo) then {
        ...
        if (_ObjectUID == "net") then {
            ...
            if (!_stopGo) then {
                ...
                s_player_1bupd = -1;
                if ((_type == "Uroven1DrevenaBudka") OR (_type == "Uroven1VelkaBudka")) then {
                    //titletext [str(_level) + " " + str(bb_base), "PLAIN DOWN",4];
                ...
                if ((_type == "Uroven2KladaDomek") OR (_type == "Uroven2MalyDomek")) then {
                ...
                if (_type == "Uroven3DrevenyDomek") then {
                    if (bb_base select 5 == 0) then { _stopGo = true; titletext ["You need to finish building a level 1 house first.", "PLAIN DOWN",4]; };
                ...
                if (_type == "Uroven3VelkyDomek") then {
                    if (bb_base select 5 == 0) then { _stopGo = true; titletext ["You need to finish building a level 1 house first.", "PLAIN DOWN",4]; };
                    if (bb_base select 6 == 0) then { _stopGo = true; titletext ["You need to finish building a level 2 house first.", "PLAIN DOWN",4]; };
                    if ((_level < 8)&&(bb_base select 2 == 1)) then {
                ...
                if (_type == "krepost") then {
                    //if (bb_base select 5 == 0) then { _stopGo = true; titletext ["You need to finish building a level 1 house first.", "PLAIN DOWN",4]; };
                    //if (bb_base select 6 == 0) then { _stopGo = true; titletext ["You need to finish building a level 2 house first.", "PLAIN DOWN",4]; };
                    //if (bb_base select 7 == 0) then { _stopGo = true; titletext ["You need to finish building a level 3 house first.", "PLAIN DOWN",4]; };
                    if ((_level < 23)&&(bb_base select 8 == 1)) then {
                        if (_nextlevelb > 8) then {
                            //diag_log ("START Open Dialog");
                            _deagOK = createDialog "KeypadHouse";
                            waitUntil { !dialog };
                            if (CODE != "") then {
                            ...
                            //diag_log ("END Open Dialog");
                            if (_passUch select 1) then {
                                _itOKbu  = [_object,6,_nextlevelb] call _invChe;
                                //diag_log format ["2g_itOKbu=%1",_itOKbu];
                            } else { _stopGo = true; };
                        } else {
                            _itOKbu  = [_object,6,_nextlevelb] call _invChe;
...
//titletext [_new /*+ " " +  str(getMagazineCargo _object)*/, "PLAIN DOWN"];