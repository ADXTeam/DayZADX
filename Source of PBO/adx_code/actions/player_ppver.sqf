...
if ((_type == "Uroven1DrevenaBudka") OR (_type == "Uroven1VelkaBudka") OR (_type == "Uroven3VelkyDomek")) then {
	_stopGo = _objectLevel < 2;
};
if ((_type == "Uroven2KladaDomek") OR (_type == "Uroven2MalyDomek") OR (_type == "Uroven3DrevenyDomek")) 	then {
	_stopGo = _objectLevel < 3;
};
if ((_type == "malaGaraz") OR (_type == "velkaGaraz")) 	then {
	_stopGo = _objectLevel < 3;
};
