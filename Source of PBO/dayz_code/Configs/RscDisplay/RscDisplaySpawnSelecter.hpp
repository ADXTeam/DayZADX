class RscDisplaySpawnSelecter {
	...
	class controlsBackground {
		class Mainback : RscPicture {
			idc = -1;
			text = "\z\addons\adx_pack\paa\spawn\spawn_bg.paa";
	...
	class controls
	{
		class RscSelectedRegion1 : RscActiveText
		{
			idc = -1;
			style = 48;
			text = "\z\addons\adx_pack\paa\spawn\spawn_berezniki.paa";
		...
		class RscSelectedRegion2: RscActiveText
		{
			idc = -1;
			style = 48;
			text = "\z\addons\adx_pack\paa\spawn\spawn_protvino.paa";
		...
		class RscSelectedRegion3: RscActiveText
		{
			idc = -1;
			style = 48;
			text = "\z\addons\adx_pack\paa\spawn\spawn_zirnitra.paa";
		...
		class RscSelectedRegion4: RscActiveText
		{
			idc = -1;
			style = 48;
			text = "\z\addons\adx_pack\paa\spawn\spawn_kovrov.paa";
		...
		class RscSelectedRegion5: RscActiveText
		{
			idc = -1;
			style = 48;
			text = "\z\addons\adx_pack\paa\spawn\spawn_kirsanov.paa";
		...
		class RscSelectedRegion6: RscActiveText
		{
			idc = -1;
			style = 48;
			text = "\z\addons\adx_pack\paa\spawn\spawn_tobolsk.paa";
		...
		class RscSelectedRegionRandom: RscActiveText
		{
			idc = -1;
			style = 48;
			text = "\z\addons\adx_pack\paa\spawn\spawn_random.paa";
