...
class RscTitles
{
    ...
    class DeathScreen_DZ {
        ...
        class DeathScreen: RscPicture {
            ...
            w = 1 * safezoneW;
            h = 1 * safezoneH;
            text = "\z\addons\dayz_code\gui\death.paa";
        };
    };
    ...
    class playerStatusGUI {
        ...
        class ControlsBackground {
            ...
            {
                idc = 1307;
                text = "z\addons\adx_pack\paa\gui\st_humanity_survivor.paa";
                x = 0.955313 * safezoneW + safezoneX;
            ...
            {
                idc = 1308;
                text = "z\addons\adx_pack\paa\gui\st_humanity_hero.paa";
                x = 0.955313 * safezoneW + safezoneX;
            ...
            {
                idc = 1309;
                text = "z\addons\adx_pack\paa\gui\st_humanity_bandit.paa";
                x = 0.955313 * safezoneW + safezoneX;
            ...
            {
                idc = 1310;
                text = "z\addons\adx_pack\paa\gui\zombie.paa";
                x = 0.955313 * safezoneW + safezoneX;
